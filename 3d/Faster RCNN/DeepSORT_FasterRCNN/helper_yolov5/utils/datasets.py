...
from helper_yolov5.utils.general import xyxy2xywh, xywh2xyxy
from helper_yolov5.utils.torch_utils import torch_distributed_zero_first
    ...
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        if self.rect:
            ...
            self.batch_shapes = np.ceil(
                np.array(shapes) * img_size / stride + pad).astype(np.int64) * stride
